<template>
  <div>
    <div v-if="loadingStats || loadingLimitStats" class="text-center"><span class="loading loading-lg loading-spinner text-info"></span></div>
    <div v-else-if="limitStats && stats">
      <div class="text-center py-8">
        <div class="stats stats-vertical lg:stats-horizontal shadow">
          ...
          <div class="stat">
            ...
            <div class="stat-value text-primary">{{ stats.quiz_count_total }}</div>
          </div>
          ...
          <div class="stat">
            ...
            <div class="stat-value text-secondary">{{ stats.points_total }}</div>
          </div>
