<template>
  <div>
    ...
    <div class="toast toast-top pt-20 md:pt-0 md:toast-bottom toast-start opacity-70 hover:opacity-90 transition-all">
      <div role="alert" class="alert">
        <svg class="hidden sm:block" xmlns="http://www.w3.org/2000/svg" width="1.2em" height="1.2em" viewBox="0 0 48 48"><g fill="none" stroke="currentColor" stroke-linejoin="round" stroke-width="4"><path d="M44 28H28v16h16zM13 4l9 16H4zm23 16a8 8 0 1 0 0-16a8 8 0 0 0 0 16Z"/><path stroke-linecap="round" d="m4 28l16 16m0-16L4 44"/></g></svg>
